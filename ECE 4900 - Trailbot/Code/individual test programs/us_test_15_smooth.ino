...
unsigned int us_range[SONAR_NUM+1] = {0, 0, 0, 0};
bool us_no_detection[SONAR_NUM+1] = {false, false, false, false};
...
int us1_total = 0;
int ir_xxx = 0;                   //running average of past numReadings
int range = 0;
int last_range = 0;
