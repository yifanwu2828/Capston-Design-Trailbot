...
//time variables
unsigned long KILL_TIMER = 60000;   //timer KILLS all action in program !!ESSENTIAL TESTING SAFETY FEATURE!!
unsigned long steer_delay = 100;    // allows times to pass after steering change
unsigned long speed_delay = 100;    // allows times to pass after speed change
...
int us_avoidance_distance = 30;     // range below which obstacle is considered detected
